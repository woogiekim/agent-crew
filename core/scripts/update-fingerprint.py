...
def build_payload(args: argparse.Namespace) -> dict:
    ...
    add_tree(entries, "output/global-codex-command-skills", codex_home / "skills")
    ...
    add_file(entries, "output/global-codex-hooks", codex_home / "hooks.json")
    add_file(entries, "output/global-codex-config", codex_home / "config.toml")
