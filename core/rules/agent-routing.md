...
| analyst | Codebase understanding, domain investigation, read-only debugging | explain, investigate, understand, map, trace, explore, audit, debug, root cause, failing test | yes | — |
